        ...
        <div className="text-center pt-6 px-2">
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              ...
              <p className=" py-2  text-gray-400">
                Nave:{" "}
                {sw.Characters[0]["R5-D4"].starship === "N/A"
                  ? "Sem nave identificada"
                  : sw.Characters[0]["R5-D4"].starship}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg h-[40vh] m-auto transition-all shadow-2xl shadow-blue-700 hover:shadow-blue-500"
            src={sw.Characters[0]["R5-D4"].img_url}
            alt={sw.Characters[0]["R5-D4"].name}
          />
        </div>
      )}
    </div>
