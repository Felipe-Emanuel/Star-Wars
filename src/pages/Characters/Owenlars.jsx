          ...
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Characters[0]["Owen Lars"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Nave:{" "}
                {sw.Characters[0]["Owen Lars"].starship === "N/A"
                  ? "Sem nave identificada"
                  : sw.Characters[0]["Owen Lars"].starship}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg h-[40vh] m-auto transition-all shadow-2xl shadow-amber-800 hover:shadow-amber-700"
            src={sw.Characters[0]["Owen Lars"].img_url}
            alt={sw.Characters[0]["Owen Lars"].name}
          />
        </div>
      )}
    </div>
