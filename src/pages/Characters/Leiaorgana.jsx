          ...
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Characters[0]["Leia Organa"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Nave:{" "}
                {sw.Characters[0]["Leia Organa"].starship === "N/A"
                  ? "Sem nave identificada"
                  : sw.Characters[0]["Leia Organa"].starship}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg h-[40vh] m-auto transition-all shadow-2xl shadow-blue-800 hover:shadow-blue-600"
            src={sw.Characters[0]["Leia Organa"].img_url}
            alt={sw.Characters[0]["Leia Organa"].name}
          />
        </div>
      )}
    </div>
