          ...
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Characters[0]["Obi Wan kenobi"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Naves:{" "}
                {sw.Characters[0]["Obi Wan kenobi"].starship === "N/A"
                  ? "Sem nave identificada"
                  : sw.Characters[0]["Obi Wan kenobi"].starship}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg w-[70vh] m-auto transition-all shadow-2xl shadow-blue-500 hover:shadow-blue-400"
            src={sw.Characters[0]["Obi Wan kenobi"].img_url}
            alt={sw.Characters[0]["Obi Wan kenobi"].name}
          />
        </div>
      )}
    </div>
