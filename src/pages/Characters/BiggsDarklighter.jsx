...
export function BiggsDarklighter() {
          ...
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Characters[0]["Biggs Darklighter"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Nave:{" "}
                {sw.Characters[0]["Biggs Darklighter"].starship === "N/A"
                  ? "Sem nave identificada"
                  : sw.Characters[0]["Biggs Darklighter"].starship}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg w-[70vh] m-auto transition-all shadow-2xl shadow-orange-500 hover:shadow-orange-400"
            src={sw.Characters[0]["Biggs Darklighter"].img_url}
            alt={sw.Characters[0]["Biggs Darklighter"].name}
          />
        </div>
      )}
    </div>
