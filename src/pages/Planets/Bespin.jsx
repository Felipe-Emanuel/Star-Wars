        ...
        <div className="text-center pt-6 px-2">
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              ...
              <p className=" py-2  text-gray-400">
                Residentes :{" "}
                {sw.planets[5].Bespin.residents === "N/A"
                  ? "Sem residentes identificados"
                  : sw.planets[5].Bespin.residents}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg w-[90vw] md:w-[70vh] lg:w-[30vw] m-auto transition-all shadow-2xl shadow-yellow-800 hover:shadow-yellow-400"
            src={sw.planets[5].Bespin.img_url}
            alt={sw.planets[5].Bespin.name}
          />
        </div>
      )}
    </div>
