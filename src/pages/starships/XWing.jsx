        ...
        <div className="text-center pt-6 px-2">
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              ...
              <p className=" py-2  text-gray-400">
                Pilotos:{" "}
                {sw.Starships[6]["X-wing"].pilots === "N/A"
                  ? "Sem pilotos identificados"
                  : sw.Starships[6]["X-wing"].pilots}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg w-[90vw] md:w-[75vh] lg:w-[45vw] m-auto transition-all shadow-2xl shadow-gray-400 hover:shadow-orange-400"
            src={sw.Starships[6]["X-wing"].img_url}
            alt={sw.Starships[6]["X-wing"].name}
          />
        </div>
      )}
    </div>
