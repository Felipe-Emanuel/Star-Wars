          ...
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Starships[3]["Death Star"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Pilotos:{" "}
                {sw.Starships[3]["Death Star"].pilots === "N/A"
                  ? "Sem pilotos identificados"
                  : sw.Starships[3]["Death Star"].pilots}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg h-[38vh] m-auto transition-all shadow-2xl shadow-gray-800 hover:shadow-gray-600"
            src={sw.Starships[3]["Death Star"].img_url}
            alt={sw.Starships[3]["Death Star"].name}
          />
        </div>
      )}
    </div>
