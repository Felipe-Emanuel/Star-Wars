    ...
    <div className="bg-star bg-cover bg-center w-screen h-screen">
      ...
      {!removeLoading ? (
        ...
        <div className="text-center pt-6 px-2">
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Starships[2]["Sentinel-class landing craft"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Pilotos:{" "}
                {sw.Starships[2]["Sentinel-class landing craft"].pilots ===
                "N/A"
          ...
          <img
            className="rounded-lg h-[45vh] m-auto opacity-80 transition-all shadow-2xl shadow-gray-800 hover:shadow-gray-600"
            src={sw.Starships[2]["Sentinel-class landing craft"].img_url}
            alt={sw.Starships[2]["Sentinel-class landing craft"].name}
          />
        </div>
      )}
    </div>
