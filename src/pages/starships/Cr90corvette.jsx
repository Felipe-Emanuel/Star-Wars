          ...
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              <h1 className=" py-2  text-gray-400">
                {sw.Starships[0]["CR90 corvette"].name}
              </h1>
              ...
              <p className=" py-2  text-gray-400">
                Pilotos:{" "}
                {sw.Starships[0]["CR90 corvette"].pilots === "N/A"
                  ? "Sem pilotos identificados"
                  : sw.Starships[0]["CR90 corvette"].pilots}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg h-[40vh] m-auto transition-all shadow-2xl shadow-amber-800 hover:shadow-amber-700"
            src={sw.Starships[0]["CR90 corvette"].img_url}
            alt={sw.Starships[0]["CR90 corvette"].name}
          />
        </div>
      )}
    </div>
