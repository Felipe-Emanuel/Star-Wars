        ...
        <div className="text-center pt-6 px-2">
          <div className="text-white pb-8 ">
            <Text className="flex flex-col w-64 m-auto">
              ...
              <p className=" py-2  text-gray-400">
                Pilotos:{" "}
                {sw.Starships[5]["Y-wing"].pilots === "N/A"
                  ? "Sem pilotos identificados"
                  : sw.Starships[5]["Y-wing"].pilots}
              </p>
            </Text>
          </div>
          <img
            className="rounded-lg w-[90vw] md:w-[75vh] lg:w-[50vw] m-auto transition-all shadow-2xl shadow-gray-400 hover:shadow-yellow-200"
            src={sw.Starships[5]["Y-wing"].img_url}
            alt={sw.Starships[5]["Y-wing"].name}
          />
        </div>
      )}
    </div>
